...
var enemy_scenes = [
	...
	"res://Game/Enemies/PlayerTracker.tscn"
]
...
func _ready():
	...
	EnemyGlobal.instance.updateInitiatedSpawnersCount(EnemyGlobal.instance.initiatedSpawnersCount + 1)	# Create and configure the respawn timers
